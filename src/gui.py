...
class GuiWindow():
    ...
    def __init__(self, text):
        ...
        self.label = tk.Label(self.root, text=text, font=('Helvetica', '20'), background='white')
        self.label.pack()
    ...
    def copy_to_clipboard(self, text):
        ...
        messagebox.showinfo('Copied to clipboard', 'Your product key has been copied to clipboard.')
